...
HD_PWD='C:/Users/eros_/Downloads/TFMPedalMultiefectosI2S_OPT_FIFO/PROJECT/PROJECT.runs/fifo_generator_test_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_generator_test.tcl
